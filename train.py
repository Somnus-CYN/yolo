...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='ghostyolo.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='coco128/images/train2017', help='data.yaml path')
